...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->DaysPanal->Location = System::Drawing::Point(155, 287);
			this->DaysPanal->Name = L"DaysPanal";
			this->DaysPanal->Size = System::Drawing::Size(465, 342);
			...
			this->label1->Location = System::Drawing::Point(169, 265);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(213, 633);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(173, 632);
			...
			this->label2->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label2->Location = System::Drawing::Point(417, 265);
			...
			this->label3->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label3->Location = System::Drawing::Point(353, 265);
			...
			this->label4->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label4->Location = System::Drawing::Point(297, 265);
			...
			this->label5->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label5->Location = System::Drawing::Point(236, 265);
			...
			this->label6->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label6->Location = System::Drawing::Point(482, 265);
			...
			this->label7->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(74)), static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(75)));
			this->label7->Location = System::Drawing::Point(548, 265);
			...
			this->panel2->Location = System::Drawing::Point(672, 37);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(110, 40);
			...
			this->button28->Location = System::Drawing::Point(80, 0);
			this->button28->Name = L"button28";
			this->button28->Size = System::Drawing::Size(30, 40);
			this->button28->TabIndex = 35;
			this->button28->UseVisualStyleBackColor = false;
			this->button28->Click += gcnew System::EventHandler(this, &MyForm::button28_Click);
			this->button28->MouseEnter += gcnew System::EventHandler(this, &MyForm::button28_MouseEnter);
			this->button28->MouseLeave += gcnew System::EventHandler(this, &MyForm::button28_MouseLeave);
			// 
			// button27
			// 
			...
			this->button27->Location = System::Drawing::Point(-1, -1);
			this->button27->Name = L"button27";
			this->button27->Size = System::Drawing::Size(30, 40);
			this->button27->TabIndex = 34;
			this->button27->UseVisualStyleBackColor = false;
			this->button27->Click += gcnew System::EventHandler(this, &MyForm::button27_Click);
			this->button27->MouseEnter += gcnew System::EventHandler(this, &MyForm::button27_MouseEnter);
...
#pragma endregion
		...
		private: System::Void button16_Click(System::Object^ sender, System::EventArgs^ e) {
			AddEventForm^ addForm = gcnew AddEventForm(user);
		    addForm->ShowDialog();
		...
		private: System::Void button17_Click(System::Object^ sender, System::EventArgs^ e) {
			DisplayAllEvents^ DisplayForm = gcnew DisplayAllEvents(user);
...
private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	for (auto it = user->Reminder_events.begin(); it != user->Reminder_events.end(); it++)
	{
		if (counter <= 2)
		{
			EventReminderCard^ ReminderCard = gcnew EventReminderCard(&it->second, user);
...
private: System::Void button20_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	else
	{
		...
		if (UsersManager::signup(newuser,password))
		{
...
private: System::Void button26_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (textBox6->Text != "Password")
	   ...
	   /// mostafa , wagih , zahran ///

private: System::Void button27_Click(System::Object^ sender, System::EventArgs^ e) {
	if (!user->undo_stack.empty())
	{
		if (user->undo_stack.top().second == "Add")
		{
			System::String^ eventName = gcnew System::String(user->undo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " delete");
			user->events.erase(user->undo_stack.top().first.getId());
			user->Reminder_events.erase(user->undo_stack.top().first.getRemId());
			user->redo_stack.push(user->undo_stack.top());
			user->undo_stack.pop();
	
			MyForm::MyForm_Load(sender, e);

		}
		else if (user->undo_stack.top().second == "delete")
		{
			System::String^ eventName = gcnew System::String(user->undo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " add");
			user->events[user->undo_stack.top().first.getId()] = user->undo_stack.top().first;
			user->Reminder_events[user->undo_stack.top().first.getRemId()] = user->undo_stack.top().first;
			
			user->redo_stack.push(user->undo_stack.top());
			user->undo_stack.pop();
			MyForm::MyForm_Load(sender, e);
		}
		else if(user->undo_stack.top().second=="Done")
		{
			System::String^ eventName = gcnew System::String(user->undo_stack.top().first.getName().c_str());
		...
		else if (user->undo_stack.top().second == "Remove From Done")
		{
			System::String^ eventName = gcnew System::String(user->undo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " will remove edit");

			user->redo_stack.push(make_pair(user->done_events.top(),"Remove From Done"));
			...
			user->redo_stack.push(make_pair(user->events[user->undo_stack.top().second], user->undo_stack.top().first.getId()));

			user->Reminder_events.erase(user->events[user->undo_stack.top().second].getRemId());
			user->events.erase(user->undo_stack.top().second);
...
private: System::Void button28_Click(System::Object^ sender, System::EventArgs^ e) {
	if (!user->redo_stack.empty())
	{
		if (user->redo_stack.top().second == "delete")
		{
			System::String^ eventName = gcnew System::String(user->redo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " delete");
			user->events.erase(user->redo_stack.top().first.getId());
			user->Reminder_events.erase(user->redo_stack.top().first.getRemId());

			//user->undo_stack.push(user->redo_stack.top());
			user->redo_stack.pop();
			//user->undo_stack.pop();
			MyForm::MyForm_Load(sender, e);

		}
		else if (user->redo_stack.top().second == "Add")
		{
			System::String^ eventName = gcnew System::String(user->redo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " add");
			user->events[user->redo_stack.top().first.getId()] = user->redo_stack.top().first;
			user->Reminder_events[user->redo_stack.top().first.getRemId()] = user->redo_stack.top().first;
		...
		else if (user->redo_stack.top().second == "Done")
		{
			System::String^ eventName = gcnew System::String(user->redo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " will be add");
			user->done_events.push(user->redo_stack.top().first);
		...
		else if (user->redo_stack.top().second == "Remove From Done")
		{
			System::String^ eventName = gcnew System::String(user->redo_stack.top().first.getName().c_str());
			MessageBox::Show("Event name :" + eventName + " will remove edit");

			//std::cout << user->redo_stack.top().second;
			//user->undo_stack.push(make_pair(user->done_events.top(),"Remove From Done"));
			...
			//user->undo_stack.push(make_pair(user->events[user->redo_stack.top().second], user->redo_stack.top().first.id));
		

			user->Reminder_events.erase(user->events[user->redo_stack.top().second].getRemId());
			user->events.erase(user->redo_stack.top().second);
...
private: System::Void button28_MouseEnter(System::Object^ sender, System::EventArgs^ e) {
	panel2->BackgroundImage = Image::FromFile("redo.png");
}


private: System::Void button28_MouseLeave(System::Object^ sender, System::EventArgs^ e) {
	panel2->BackgroundImage = Image::FromFile("normal.png");

}
private: System::Void button27_MouseEnter(System::Object^ sender, System::EventArgs^ e) {
	panel2->BackgroundImage = Image::FromFile("undo.png");
}
