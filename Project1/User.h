...
public:
	...
	// undo redo functions                    mostafa , zahran , wagih

	bool add_event(Event new_event);                        //mohamed
	void delete_event(std::string id);                      //yossery
	bool update_event(std::string id, Event updated_event); //abdalla
