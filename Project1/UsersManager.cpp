...
bool UsersManager::login(std::string newuser, std::string password) {
	if (userList[newuser].getPassword() == password) {
		return true;
	}
	else
		return false;
